    ...
    protected Void doInBackground(Void... longs) {
        ...
        try {
            ...
            while (i > 0) {
                ...
                json.put("deviceId", this.activity.getDeviceId());
                json.put("msgId", "Message id " + Integer.toString(i));
                json.put("temperature", this.activity.getTemperature());
                json.put("humidity", this.activity.getHumidity());
                json.put("time", getUTCdatetimeAsString());
                Log.d(TAG, json.toString());
                try {
                    Message msg = new Message(json.toString());
                    msg.setProperty("SensorType", "thermometer");
